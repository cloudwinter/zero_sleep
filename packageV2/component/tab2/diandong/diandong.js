...
Component({
  ...
  */
   ...
   */
    ...
    diandongSetTap() {
      wx.navigateTo({
        url: '/packageV2/pages/mainv2/diandongset/diandongset'
      })
    },
   ...
   */
      ...
      if (this.data.isFirstAlarm) {
        ...
        wx.showModal({
          ...
          complete: (res) => {
            ...
            if (res.confirm) {
              wx.navigateTo({
                url: '/packageV2/pages/mainv2/diandongset/diandongset?isFirstAlarm=1',
              })
            }
          }
        })
    ...
    tapZhinengjiance() {
      ...
      if (type == '01' || type == '02') {
        ...
        wx.navigateTo({
          url: '/packageV2/pages/mainv2/zhinengjiance/zhinengjiance',
        })
      } else {
