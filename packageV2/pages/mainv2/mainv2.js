...
Page({
  ...
  tapSearch(e) {
    ...
    if (type == 'diandong') {
      ...
      if (!bedState) {
        wx.navigateTo({
          url: '/packageV2/pages/mainv2/searchv2/searchv2?type=' + type + '&connected=' + connectedStr,
        })
        return
      }
    } else if (type == 'qinang') {
    ...
    wx.navigateTo({
      url: '/packageV2/pages/mainv2/bedstead/bedstead?type=' + type + '&connected=' + connectedStr + "&cmd=" + cmd,
    })
  },
