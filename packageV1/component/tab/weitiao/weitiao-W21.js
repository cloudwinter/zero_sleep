// component/tab/weitiao/weitiao-W21.js
...
Component({
  ...
  data: {
    ...
    connected: {},
    currentAnjian: {
      anjian: 'toubutz', //toubutz beibutz,tuibutz,jiaobutz
      name: '头部调整' //头部调整,背部调整,腿部调整,脚部调整，
    },
  ...
  methods: {
    ...
    touchStart(e) {
      ...
      if (type == 'beibutzTop') {
        ...
        this.donghua(true, this);
        this.tapJiaobutz(true, true);
      } else if (type == 'jiaobutzBottom') {
        this.setData({
          currentAnjian: {
            anjian: 'jiaobutz',
            name: '脚部调整'
    ...
    touchEnd(e) {
      ...
      if (type == 'beibutzTop') {
        ...
        this.tapJiaobutz(true, false);
      } else if (type == 'jiaobutzBottom') {
        this.setData({
          jiaobutzBottom: false
        });
        this.tapJiaobutz(false, false);
      }
    },
