// component/tab/weitiao/weitiao-W6.js
...
Component({
  ...
  data: {
    ...
    connected: {},
    currentAnjian: {
      anjian: 'beibutz', // beibutz,zhengtisj
      name: '背部调整' // 背部调整，整体升降
    },
  ...
  lifetimes: {
    created: function () {
      // 在组件实例刚刚被创建时执行
      console.info("weitiao-W6-->created");
      var that = this;
  ...
  methods: {
    ...
    initConnected(connected) {
      ...
      console.info('weitiao-W6->initConnected:', connected, this.observer);
      that.setData({
        connected: connected,
      })
    ...
    touchStart(e) {
      ...
      if (type == 'beibutzTop') {
        ...
        this.donghua(true, this);
        this.tapZhengtisj(true, true);
      } else if (type == 'zhengtisjBottom') {
        this.setData({
          currentAnjian: {
            anjian: 'zhengtisj',
            name: '整体升降'
          },
          zhengtisjBottom: true
        });
        this.donghua(false, this);
        this.tapZhengtisj(false, true);
      }
    },
    /**
     * 抬起事件
    ...
    touchEnd(e) {
      ...
      if (type == 'beibutzTop') {
        ...
        this.tapZhengtisj(true, false);
      } else if (type == 'zhengtisjBottom') {
        this.setData({
          zhengtisjBottom: false
        });
        this.tapZhengtisj(false, false);
      }
    },
