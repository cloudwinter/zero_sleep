// component/tab/weitiao/weitiao-w9.js
...
Component({
  ...
  data: {
    ...
    currentAnjian: {
      anjian: 'beibutz', // beibutz,qingxie,yaobutz,tuibutz
      name: '背部调整' // 背部调整，倾斜，腰部调整，腿部调整
    },
  ...
  lifetimes: {
    created: function () {
      // 在组件实例刚刚被创建时执行
      console.info("weitiao-W9-->created");
      var that = this;
  ...
  methods: {
    ...
    initConnected(connected) {
      ...
      console.info('weitiao-W9->initConnected:', connected, this.observer);
      that.setData({
        connected: connected,
      })
    ...
    touchStart(e) {
      ...
      if (type == 'beibutzTop') {
        ...
        this.donghua(true, this);
        this.tapQingxie(true, true);
      } else if (type == 'qingxieBottom') {
        this.setData({
          currentAnjian: {
            anjian: 'qingxie',
            name: '倾斜'
    ...
    touchEnd(e) {
      ...
      if (type == 'beibutzTop') {
        ...
        this.tapQingxie(true, false);
      } else if (type == 'qingxieBottom') {
        this.setData({
          qingxieBottom: false
        });
        this.tapQingxie(false, false);
      } else if (type == 'tuibutzTop') {
        this.setData({
          tuibutzTop: false
        });
